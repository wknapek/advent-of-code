...
func (Warehouse) ParseGrid(gridStr string) ([][]*Object, Robot15) {
...
func day15Calculate() {
	dat, err := os.ReadFile("inputs/day15.txt")
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println(solve_pt1(string(dat), []string{}))
	fmt.Println(solve_pt2(string(dat), []string{}))
}
